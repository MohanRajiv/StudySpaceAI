module.exports = [
"[project]/actions/data:df44e1 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$df44e1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:df44e1 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
function CreateTodo() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$df44e1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createTodo"])(text);
            setText("");
        } catch (e) {
            console.log(e);
        }
...
//# sourceMappingURL=_e8d2c73e._.js.map